...
public class FeignClientConfig {
    ...
    public PreDepositedAccountClientService preDepositedAccountClient() {
        return Feign.builder()
	    		  ...
	    		  .target(PreDepositedAccountClientService.class, this.appRunningProperties.getBaseUrl()+"/pre-deposited-account");
    }
    ...
    public RetailAccountClientService retailAccountClientService() {
        return Feign.builder()
	    		  ...
	    		  .logLevel(Logger.Level.FULL)
	    		  .target(RetailAccountClientService.class, this.appRunningProperties.getBaseUrl()+"/retail-account");
    }
